...
class ProfileData {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('exchanges')) obj.exchanges = _ApiClient.ApiClient.convertToType(data['exchanges'], ['String']);
      if (data.hasOwnProperty('products')) obj.products = _ApiClient.ApiClient.convertToType(data['products'], ['String']);
      if (data.hasOwnProperty('broker')) obj.broker = _ApiClient.ApiClient.convertToType(data['broker'], 'String');
      if (data.hasOwnProperty('user_id')) obj.userId = _ApiClient.ApiClient.convertToType(data['user_id'], 'String');
      if (data.hasOwnProperty('user_name')) obj.userName = _ApiClient.ApiClient.convertToType(data['user_name'], 'String');
      if (data.hasOwnProperty('order_types')) obj.orderTypes = _ApiClient.ApiClient.convertToType(data['order_types'], ['String']);
      if (data.hasOwnProperty('user_type')) obj.userType = _ApiClient.ApiClient.convertToType(data['user_type'], 'String');
      if (data.hasOwnProperty('poa')) obj.poa = _ApiClient.ApiClient.convertToType(data['poa'], 'Boolean');
      if (data.hasOwnProperty('is_active')) obj.isActive = _ApiClient.ApiClient.convertToType(data['is_active'], 'Boolean');
    }
    return obj;
  }
}
