...
exports.PlaceOrderV3Request = void 0;
...
class PlaceOrderV3Request {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('disclosed_quantity')) obj.disclosedQuantity = _ApiClient.ApiClient.convertToType(data['disclosed_quantity'], 'Number');
      if (data.hasOwnProperty('trigger_price')) obj.triggerPrice = _ApiClient.ApiClient.convertToType(data['trigger_price'], 'Number');
      if (data.hasOwnProperty('is_amo')) obj.isAmo = _ApiClient.ApiClient.convertToType(data['is_amo'], 'Boolean');
    }
    return obj;
  }
}
 ...
 */
exports.PlaceOrderV3Request = PlaceOrderV3Request;
