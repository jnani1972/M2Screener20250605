...
exports.GttPlaceOrderRequest = void 0;
var _ApiClient = require("../ApiClient");
var _GttRule = require("./GttRule");
/*
 * OpenAPI definition
...
class GttPlaceOrderRequest {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('rules')) obj.rules = _ApiClient.ApiClient.convertToType(data['rules'], [_GttRule.GttRule]);
 ...
 * @readonly
 */
exports.GttPlaceOrderRequest = GttPlaceOrderRequest;
