...
exports.MarketDataFeeder = void 0;
...
class MarketDataFeeder extends _Feeder.default {
  ...
  async connect() {
    ...
    this.ws = await this.connectWebSocket(`wss://api.upstox.com/v2/feed/market-data-feed`, this.apiClient.authentications["OAUTH2"].accessToken);
    this.onOpen();
    this.onMessage();
    this.onClose();
    this.onError();
  ...
  async initProtobuf() {
    const protoPath = _path.default.resolve(__dirname, "./proto/MarketDataFeed.proto");
...
exports.MarketDataFeeder = MarketDataFeeder;